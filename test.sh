...
colins_asg=('dev-website-website-blue-20200515221620972100000004' 
'production-drive-report-green-2018122023334785650000000b')

command="aws autoscaling describe-auto-scaling-groups --auto-scaling-group-name $asg"
#echo ${colins_asg[*]}

i=0
for asg in ${colins_asg[*]}
do
  if [ $("$command") ]; then
    $command
    i=$((i+1))
